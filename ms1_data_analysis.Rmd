...
Figure 1. Median, 1st, second quadrilles, 1.5 IRQ distance, and outliers (labeled) for logarithm of biomass, richness diversity, and density for the three studied location/elevation.
...
# Plot
ggpubr::ggarrange(pslap, psitep, plabup)

ggpubr::ggarrange(ilabup)

ggpubr::ggarrange(hwaterp, hsitep, hlabup, hlrrslap)
