...
Elevations were similar in their baseline productivity (total biomass). Mid and high elevations had the highest baseline productivity (total biomass). Abundance and species richness.  decreased with elevation. Control plots in Numba are more variable than in other two elevations. Yawan has one site with lowest abundance (garden number seven).However no significant differences in variance were detected (Levene's and Bartellet's tests)
