...
modelDefinitions <-  function () {
  ...
  # NO TRAITS
  no.traits <- gls(
    lrrtb ~ richness + labu + lrrsla + lrrwtrc + fsite,
    data = moddata,
    method = "ML",
    correlation = corMartins(2.718282,
                             phy = myTree.rand.poly,
  ...
  # FULL MODEL
  full.model <- gls(
    lrrtb ~ lsla.d*fsite+ I(lsla.d^2)*fsite+water.cont*fsite+I(water.cont^2)*fsite+
      richness+labu+lrrsla+lrrwtrc+fsite,
    data = moddata,
    method = "ML",
    correlation = corMartins(2.718282,
                             phy = myTree.rand.poly,
  ...
  full.model.noint <- gls(
    lrrtb ~ lsla.d + I(lsla.d^2) + water.cont + I(water.cont^2) + 
      richness+labu+lrrsla+lrrwtrc+fsite,
    data = moddata,
    method = "ML",
    correlation = corMartins(2.718282,
  ...
  all.linear <- gls(
    lrrtb ~ lsla.d*fsite + water.cont*fsite + 
      richness + labu + lrrsla + lrrwtrc + fsite,
    data = moddata,
    method = "ML",
    correlation = corMartins(2.718282,
  ...
  just.sla.quadratic <- gls(
    lrrtb ~ lsla.d*fsite + I(lsla.d^2)*fsite + 
      richness + labu + lrrsla + lrrwtrc + fsite,
    data = moddata,
    method = "ML",
    correlation = corMartins(2.718282,
  ...
  just.water.quadratic.noint <- gls(
    lrrtb ~ water.cont + I(water.cont^2) + 
      richness + labu + lrrsla + lrrwtrc + fsite,
    data = moddata,
    method = "ML",
    correlation = corMartins(2.718282,
  ...
  just.water.quadratic <- gls(
    lrrtb ~ water.cont * fsite + I(water.cont^2) * fsite + 
      richness + labu + lrrsla + lrrwtrc + fsite,
    data = moddata,
    method = "ML",
    correlation = corMartins(2.718282,
  ...
  q.sla.l.water <- gls(
    lrrtb ~ lsla.d*fsite+ I(lsla.d^2)*fsite+water.cont*fsite + 
      richness + labu + lrrsla + lrrwtrc + fsite,
    data = moddata,
    method = "ML",correlation = corMartins(2.718282,                    
                                           phy = myTree.rand.poly,    
  ...
  l.sla.q.water <- gls(
    lrrtb ~ lsla.d*fsite+water.cont*fsite+I(water.cont^2)*fsite + 
      richness + labu + lrrsla + lrrwtrc + fsite,
    data = moddata,
    method = "ML",correlation = corMartins(2.718282,                 
                                           phy = myTree.rand.poly,
